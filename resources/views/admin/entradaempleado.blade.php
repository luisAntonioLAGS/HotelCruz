    ...
    <div class="xl:pl-72">
        ...
        <main>
            <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                <div>
                    <h2 class="text-base font-semibold leading-7 text-white">Entrada Empleado</h2>
                </div>

                <form class="flex items-start md:col-span-2" method="POST" action="{{route('entradaempleadopost')}}">
                    @csrf
