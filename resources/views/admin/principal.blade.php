            ...
            <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                ...
                <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                  ...
                  <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                    <div class="text-sm">
                      <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">Ver asistencias</a>
                    </div>
                  </div>
                </dd>
              </div>
              ...
              <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                ...
                <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                  ...
                  <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                    <div class="text-sm">
                      <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">Ver clientes</a>
                    </div>
                  </div>
                </dd>
              </div>
                  ...
                  <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        <tr>
                          <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">Juan gabriel lopez lopez</td>
                          <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Cantante</td>
                          <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Eljuanga@example.com</td>
                          <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Recepcionista</td>
